...
Point = namedtuple('Point', 'x, y') # ("name of tuple", "var1, var2, ...")
...
class SnakeGame:
    ...
    def _update_ui(self):
        ...
        for point in self.snake:
            pygame.draw.rect(self.dispaly, BLUE1, pygame.Rect(point.x, point.y, BLOCK_SIZE, BLOCK_SIZE))
            pygame.draw.rect(self.dispaly, BLUE2, pygame.Rect(point.x+2, point.y+2, int(0.75*BLOCK_SIZE), int(0.75*BLOCK_SIZE)))
